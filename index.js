...
app.get('/employeedashboard', async (req, res, next) => {
    res.sendFile(__dirname + '/views/employee/index.html');
});

app.get('/projects', async (req, res, next) => {
    res.sendFile(__dirname + '/views/employee/projects.html');
});

app.get('/trainings', async (req, res, next) => {
    res.sendFile(__dirname + '/views/employee/trainings.html');
});

app.get('/profile', async (req, res, next) => {
    res.sendFile(__dirname + '/views/employee/profile.html');
});
...
app.post('/department', async (req, res, next) => {
     try {
        ...
        var employees_required=data.employees_required
        var current_employees=data.current_employees
        ...
        const connection=await pool.getConnection((err, connection) => {
            ...
            var cont="INSERT INTO  departments (department_name,employees_required,current_employees) VALUES('"+department_name+"','"+employees_required+"','"+current_employees+"')";
